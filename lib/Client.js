...
class Client {
  ...
  constructor(initialToken, synchronizationStrategy, initialMessageCount) {
    // accessManager
    this._accessManager = new AccessManager(initialToken);
    this._accessManager.registerClient(this);
  ...
  onTokenExpired = (callback) => {
    if (callback) callback(this._accessManager);
  };
  ...
  _removeListeners() {
    ...
    this._accessManager.removeListeners();
  }
}
